...
> Answer: The benfits of using client side routing is Because when using data less data is processed and also routing between views is generally faster and Smooth transitions and animations between views are easier to implement.
